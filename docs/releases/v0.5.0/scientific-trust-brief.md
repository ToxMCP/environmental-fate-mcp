...
- Red-team blocker state: `0` open blockers, `0` unresolved findings, and `25` accepted public limitations.
- Erosion/sediment validation demo pack: `4` synthetic cases, passed `True`.
- External benchmark pack: `8` deterministic replay cases, passed `True`.
- Default sensitivity profiles: `11` governed profiles, passed `True`.
- Experimental fugacity screening: `2` method profiles, passed `True`.
- Evidence-quality matrix: `34` claim rows and `5` model-family rows, passed `True`.
