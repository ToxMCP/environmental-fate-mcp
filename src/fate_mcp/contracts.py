...
SCHEMA_MODELS = {
    ...
    "erosionSedimentMethodProfile.v1": ErosionSedimentMethodProfile,
    "erosionSedimentMethodProfileManifest.v1": ErosionSedimentMethodProfileManifest,
    "fugacityScreeningMethodProfile.v1": FugacityScreeningMethodProfile,
    "fugacityScreeningMethodProfileManifest.v1": FugacityScreeningMethodProfileManifest,
    "erosionSedimentValidationProfile.v1": ErosionSedimentValidationProfile,
    "erosionSedimentValidationProfileManifest.v1": ErosionSedimentValidationProfileManifest,
    "erosionSedimentValidationDemoCase.v1": ErosionSedimentValidationDemoCase,
    "erosionSedimentValidationDemoPackManifest.v1": ErosionSedimentValidationDemoPackManifest,
    "scientificExternalBenchmarkCase.v1": ScientificExternalBenchmarkCase,
    "scientificExternalBenchmarkPackManifest.v1": ScientificExternalBenchmarkPackManifest,
    "scientificEvidenceQualityRubric.v1": ScientificEvidenceQualityRubric,
    "scientificEvidenceQualityMatrixReport.v1": ScientificEvidenceQualityMatrixReport,
    "defaultSensitivityProfile.v1": DefaultSensitivityProfile,
    "defaultSensitivityProfileManifest.v1": DefaultSensitivityProfileManifest,
    "defaultSensitivityVariantResult.v1": DefaultSensitivityVariantResult,
    "defaultSensitivityReport.v1": DefaultSensitivityReport,
    "buildDefaultSensitivityReportRequest.v1": BuildDefaultSensitivityReportRequest,
    ...
    "screenErosionTransportRelevanceRequest.v1": ScreenErosionTransportRelevanceRequest,
    "erosionTransportRelevanceResult.v1": ErosionTransportRelevanceResult,
    "estimateSoilLossRusleRequest.v1": EstimateSoilLossRusleRequest,
    "soilLossRusleResult.v1": SoilLossRusleResult,
    "estimateEventSedimentYieldMusleRequest.v1": EstimateEventSedimentYieldMusleRequest,
    "eventSedimentYieldMusleResult.v1": EventSedimentYieldMusleResult,
    "estimateSedimentAssociatedChemicalLoadRequest.v1": EstimateSedimentAssociatedChemicalLoadRequest,
    "sedimentAssociatedChemicalLoadResult.v1": SedimentAssociatedChemicalLoadResult,
    "observedErosionSedimentValidationRecord.v1": ObservedErosionSedimentValidationRecord,
    "predictedErosionSedimentValidationRecord.v1": PredictedErosionSedimentValidationRecord,
    "buildErosionSedimentValidationCaseRequest.v1": BuildErosionSedimentValidationCaseRequest,
    "erosionSedimentValidationCaseResult.v1": ErosionSedimentValidationCaseResult,
    "assessErosionSedimentValidationFitRequest.v1": AssessErosionSedimentValidationFitRequest,
    "erosionSedimentValidationFitResult.v1": ErosionSedimentValidationFitResult,
    ...
    "probabilisticSampleManifest.v1": ProbabilisticSampleManifest,
    "probabilisticSampleRecord.v1": ProbabilisticSampleRecord,
