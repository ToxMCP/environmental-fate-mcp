...
DOC_RESOURCE_MAP = {
    ...
    "scientific-trust-pack": "docs/releases/v0.2.0/scientific-trust-pack.md",
    "scientific-trust-brief": "docs/releases/v0.2.0/scientific-trust-brief.md",
    "reference-proof-brief": "docs/releases/v0.2.0/reference-proof-brief.md",
    "advective-promotion-brief": "docs/releases/v0.2.0/advective-promotion-brief.md",
}
