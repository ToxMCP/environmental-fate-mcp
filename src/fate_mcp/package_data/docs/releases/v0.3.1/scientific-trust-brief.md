...
- Red-team blocker state: `0` open blockers, `0` unresolved findings, and `19` accepted public limitations.
- Erosion/sediment validation demo pack: `4` synthetic cases, passed `True`.
- External benchmark pack: `4` deterministic replay cases, passed `True`.
- Default sensitivity profiles: `7` governed profiles, passed `True`.
