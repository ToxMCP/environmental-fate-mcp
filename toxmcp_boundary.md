# ToxMCP Platform Boundary — Direct-Use Exposure MCP, Environmental Fate MCP, Dietary MCP
...
Create **Environmental Fate MCP** and **Dietary MCP** as **sibling MCPs** to Direct-Use Exposure MCP, not as submodules inside it.

The clean split is:

- **Direct-Use Exposure MCP** = human **direct-use / near-field concentration-to-dose**
- **Environmental Fate MCP** = environmental **source-to-concentration**
...
- **Environmental release and multimedia fate** go to **Environmental Fate MCP**
...
| Environmental Fate MCP | Environmental release scenarios, multimedia fate/transfer, compartment concentrations, concentration surfaces for downstream use | Direct human dose calculation, dietary intake, PBPK, final risk conclusions | `environmental_release_scenario`, `concentration_surface`, `fate_run_summary`, `fate_assumption_record` |
...
| “What environmental concentrations result from releases to media?” | Environmental Fate MCP |
...
- **Environmental oral from water or soil** = not Dietary by default; treat as a future
  concentration-to-intake workflow that starts from Environmental Fate MCP `concentration_surface`
  outputs rather than forcing oral intake into Environmental Fate MCP itself

### Inhalation
- **Indoor / near-field / room-use inhalation** = Direct-Use Exposure MCP
- **Regional outdoor air concentration due to emissions and transport** = Environmental Fate MCP
...
2. Add **Environmental Fate MCP** next because it creates reusable concentration surfaces for downstream workflows.
3. Add **Dietary MCP** after Environmental Fate MCP, with a sharp focus on food-mediated oral intake rather than “all oral”.
